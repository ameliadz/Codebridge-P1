...
class nailPolish {
	constructor(brand, name, description, price, images){
		this.brand = brand;
		this.name = name;
...
const AECrownOfThistles = new nailPolish('A England', 'Crown of Thistles', 'Orchid with holographic sparkle.', 10, ['../media/a-england-crown-of-thistles.jpg', '../media/crown-of-thistles-swatch.jpg']);

const AEJeReviens = new nailPolish('A England', 'Je Reviens', 'Pale lilac with holographic sparkle.', 10, ['../media/a-england-je-reviens.jpg', '../media/je-reviens-swatch.jpg']);

const AESaintGeorge = new nailPolish('A England', 'Saint George', 'Saturated holographic teal.', 10, ['../media/a-england-saint-george.jpg', '../media/saint-george-swatch.png']);

const CadHugTheDog = new nailPolish('Cadillacquer', 'Hug the Dog', 'Light blue-green crelly with holo and multichrome red flakes.', 10, ['../media/cadillacquer-hug-the-dog.jpg', '../media/hug-the-dog-swatch.jpg']);

const CadSookie = new nailPolish('Cadillacquer', 'Sookie', 'Baby pink crelly with blue glitter.', 10, ['../media/cadillacquer-sookie.jpg', '../media/sookie-swatch.jpeg']);

const CadVictoria = new nailPolish('Cadillacquer', 'Victoria', 'Gray crelly with variously-sized bright pink glitter.', 10, ['../media/cadillacquer-victoria.jpg', '../media/victoria-swatch.jpeg']);

const CadWearItLikeArmour = new nailPolish('Cadillacquer', 'Wear It Like Armour', 'Lavender crelly with variously-sized copper glitter.', 10, ['../media/cadillacquer-wear-it-like-armour.jpg', '../media/wear-it-like-armour-swatch.jpg']);

const CirqueGarnet = new nailPolish('Cirque Colors', 'Garnet', 'Holographic burgundy red.', 10, ['../media/cirque-garnet.jpg', '../media/garnet-swatch.jpg']);

const CirqueNocturne = new nailPolish('Cirque Colors', 'Nocturne', 'Periwinkle blue with teal shimmer and delicate holographic sparkle.', 10, ['../media/cirque-nocturne.jpg', '../media/nocturne-swatch.jpg']);

const CirqueVelvetine = new nailPolish('Cirque Colors', 'Velvetine', 'Muted slate blue with copper shimmer and delicate holographic sparkle.', 10, ['../media/cirque-velvetine.jpg', '../media/velvetine-swatch.jpg']);

const ILNPAbundanceH = new nailPolish('I Love Nail Polish', 'Abundance (H)', 'Red-bronze-gold multichrome with strong copper shimmer and added holographic shine.', 10, ['../media/ilnp-abundance-h.jpg', '../media/abundance-h-swatch.jpg']);

const ILNPCityscape = new nailPolish('I Love Nail Polish', 'Cityscape', 'Black jelly with scattered holographic sparkle.', 10, ['../media/ilnp-cityscape.jpg', '../media/cityscape-swatch.jpg']);

const ILNPCozyMittens = new nailPolish('I Love Nail Polish', 'Cozy Mittens', 'Palest gray with fine golden flakes.', 10, ['../media/ilnp-cozy-mittens.jpg', '../media/cozy-mittens-swatch.jpg']);

const ILNPGoodVibes = new nailPolish('I Love Nail Polish', 'Good Vibes', 'Bright juicy cobalt blue jelly with scattered holographic sparks.', 10, ['../media/ilnp-good-vibes.jpg', '../media/good-vibes-swatch.jpg']);

const ILNPOpenFields = new nailPolish('I Love Nail Polish', 'Open Fields', 'Multichrome blue to green flakes in a clear base.', 10, ['../media/ilnp-open-fields.jpg', '../media/open-fields-swatch.jpg']);

const KBSViciousCircles = new nailPolish('KBShimmer', 'Vicious Circles', 'Scarlet red jelly with silver micro bars and holographic circle and hex glitter.', 10, ['../media/kbshimmer-vicious-circles.jpg', '../media/vicious-circles-swatch.jpg']);

const KBSYouAutumnKnow = new nailPolish('KBShimmer', 'You Autumn Know', 'Soft white crelly with fuchsia, gold, and orange glitter.', 10, ['../media/kbshimmer-you-autumn-know.jpg', '../media/you-autumn-know-swatch.jpg']);
...
const generate = () => {
	...
	let adjectives = ['sparkly', 'metallic', 'neon', 'holographic', 'glitter', 'shimmer'];
	let polishTypes = ['creme', 'jelly', 'crelly'];
	let num1 = Math.floor(Math.random() * colorOptions.length);
	let num2 = Math.floor(Math.random() * adjectives.length);
	let num3 = Math.floor(Math.random() * polishTypes.length);
	document.getElementById('random').innerHTML = `a ${colorOptions[num1]} ${adjectives[num2]} ${polishTypes[num3]} polish?`;
};
